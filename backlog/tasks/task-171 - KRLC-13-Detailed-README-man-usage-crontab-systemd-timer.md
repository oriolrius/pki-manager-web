...
- [ ] #4 The README explicitly warns that NTP is required and that the encrypted endpoint serves the Host-CA KRL (not the User-CA KRL sshd RevokedKeys expects), cross-linking decision-015
<!-- AC:END -->
