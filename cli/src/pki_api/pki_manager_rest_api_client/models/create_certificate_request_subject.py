...
T = TypeVar("T", bound="CreateCertificateRequestSubject")


@_attrs_define
class CreateCertificateRequestSubject:
    """
    Attributes:
        common_name (str):
        organization (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_certificate_request_subject = cls(
        ...
        return create_certificate_request_subject
