...
T = TypeVar("T", bound="PostCasBodySubject")


@_attrs_define
class PostCasBodySubject:
    """
    Attributes:
        common_name (str):
        organization (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_cas_body_subject.additional_properties = d
        return post_cas_body_subject
