...
T = TypeVar("T", bound="PostCertificatesBulkRevokeResponse200ResultsItem")


@_attrs_define
class PostCertificatesBulkRevokeResponse200ResultsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_certificates_bulk_revoke_response_200_results_item = cls(
            certificate_id=certificate_id,
            success=success,
            error=error,
        )

        post_certificates_bulk_revoke_response_200_results_item.additional_properties = d
        return post_certificates_bulk_revoke_response_200_results_item
