...
from ..models.post_certificates_response_201_status import PostCertificatesResponse201Status
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostCertificatesResponse201")


@_attrs_define
class PostCertificatesResponse201:
    """
    Attributes:
        id (UUID | Unset):
        subject (str | Unset):
        ...
        status (PostCertificatesResponse201Status | Unset):
    """
    ...
    status: PostCertificatesResponse201Status | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_status, Unset):
            ...
            status = PostCertificatesResponse201Status(_status)

        post_certificates_response_201 = cls(
            id=id,
            subject=subject,
        ...
        post_certificates_response_201.additional_properties = d
        return post_certificates_response_201
