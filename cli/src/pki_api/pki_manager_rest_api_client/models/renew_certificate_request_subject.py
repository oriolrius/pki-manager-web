...
T = TypeVar("T", bound="RenewCertificateRequestSubject")


@_attrs_define
class RenewCertificateRequestSubject:
    """
    Attributes:
        common_name (str):
        organization (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        renew_certificate_request_subject = cls(
        ...
        return renew_certificate_request_subject
