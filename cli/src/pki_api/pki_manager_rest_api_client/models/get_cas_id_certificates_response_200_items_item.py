...
from ..models.get_cas_id_certificates_response_200_items_item_expiry_status import (
    GetCasIdCertificatesResponse200ItemsItemExpiryStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetCasIdCertificatesResponse200ItemsItem")


@_attrs_define
class GetCasIdCertificatesResponse200ItemsItem:
    """
    Attributes:
        id (UUID | Unset):
        ca_id (UUID | Unset):
        ...
        status (str | Unset):
        expiry_status (GetCasIdCertificatesResponse200ItemsItemExpiryStatus | Unset):
    ...
    expiry_status: GetCasIdCertificatesResponse200ItemsItemExpiryStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_expiry_status, Unset):
            ...
            expiry_status = GetCasIdCertificatesResponse200ItemsItemExpiryStatus(_expiry_status)
        ...
        get_cas_id_certificates_response_200_items_item = cls(
            id=id,
            ca_id=ca_id,
        ...
        get_cas_id_certificates_response_200_items_item.additional_properties = d
        return get_cas_id_certificates_response_200_items_item
