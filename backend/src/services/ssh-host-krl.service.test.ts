...
/** Minimal structural KRL decode: serial groups per CA blob + sha256 hash entries. */
function decodeKrl(blob: Buffer): { serialsByCaHex: Map<string, bigint[]>; hashes: string[] } {
